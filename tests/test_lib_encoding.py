"""Tests for lib.encoding — VideoToolbox detection, encoder args, and LUT filter."""
...
from lib.encoding import has_videotoolbox, get_video_encoder_args, get_lut_filter
...
class TestGetVideoEncoderArgs:
    ...
    def test_videotoolbox_when_hw_accel_enabled(self):
        """VideoToolbox should be used when use_hardware_accel is True (default)."""
